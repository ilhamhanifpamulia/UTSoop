...
public class Mahasiswa {
    ...
    public void printMenu() {
        Scanner ipam = new Scanner(System.in);
        System.out.println("------------------------------------");
    ...
    public void hapusData() {
        ...
        int idx = Integer.parseInt(ipam.nextLine());
        // proses hapus data
    ...
    public void ubahData() {
        ...
        String nim = ipam.nextLine();
        System.out.print("Nama      : ");
        String nama = ipam.nextLine();
        System.out.print("Prodi     : ");
        String prodi = ipam.nextLine();
        System.out.print("alamat    : ");
        String alamat = ipam.nextLine();
        // proses ubah data
        ...
        while (true) {
            ...
            switch (pilihan) {
                ...
                case 5:
                    ...
                    char persetuju = ipam.next().charAt(0);
                    if (persetuju == '1') {
                        app.printMenu();
//                        pilihan = ipam.nextInt();
